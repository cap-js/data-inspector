  ...
  function (Controller, Filter, FilterOperator, Sorter, JSONModel) {
    ...
    return Controller.extend("sap.cap.datainspector.datainspectorui.controller.columnview", {
      ...
      onRouteMatched: function (oEvent) {
        ...
        if (
          this.getOwnerComponent()._aSelectedColumnKeys &&
          this.getOwnerComponent()._aSelectedColumnKeys.length > 0
        ) {
      ...
      _loadODataProduct: function (sName) {
        var oContextBinding = this.oODataModel.bindContext(
          "/EntityDefinition('" + sName + "')",
          null,
          {
            $select: "elements",
          }
            ...
            function (oHelper) {
              ...
              this.oRouter.navTo("entityDataList", {
                ...
                selectedColumns: encodeURIComponent(
                  JSON.stringify(this.getOwnerComponent()._aSelectedColumnKeys)
                ),
