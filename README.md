...
3. Create the test sqlite db: 
   1. `cd test`
   2. `cds deploy -2 sqlite:db/testservice.db`
   3. `cd ..`
4. Run the test server: `npm run dev` the UI5 app will be launched in a web browser
5. Supply credentials: Username: `alice`; Password: keep empty
<!-- 
### Local Testing
